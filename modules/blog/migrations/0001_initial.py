    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_description', models.TimeField(verbose_name='Полное описание')),
                ...
                ('author', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='author_posts', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['-fixed', '-time_create', '-status'], name='app_article_fixed_27cd51_idx')],
            },
        ),
    ]
